 ...
 * 
 */
@Component ( "hbaseConfigStrategy")
public class HbaseConfigStrategy implements ConfigurationStrategy
{

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger( HbaseConfigStrategy.class );
